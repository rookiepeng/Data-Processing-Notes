...
#
# Saved data file:
#        1) "S11_amp <timestamp>": Amplitude data in dB
#        2) "S11_phs <timestamp>": Phase data in degree
#
# Version 1
#
# By: Zhengyu Peng
...
famp = open('S11_amp ' + timestamp, 'a')
famp.write(amp + "\n")
famp.close()

fphs = open('S11_phs ' + timestamp, 'a')
fphs.write(phs + "\n")
fphs.close()
