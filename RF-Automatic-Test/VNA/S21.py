...
#
# Saved data file:
#        1) "S21_amp <timestamp>": Amplitude data in dB
#        2) "S21_phs <timestamp>": Phase data in degree
#
# Version 1
#
# By: Zhengyu Peng
...
famp = open('S21_amp ' + timestamp, 'a')
famp.write(amp + "\n")
famp.close()

fphs = open('S21_phs ' + timestamp, 'a')
fphs.write(phs + "\n")
fphs.close()
