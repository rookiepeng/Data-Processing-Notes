...
#
# Saved data file:
#        1) "S12_amp <timestamp>": Amplitude data in dB
#        2) "S12_phs <timestamp>": Phase data in degree
#
# Version 1
#
# By: Zhengyu Peng
...
famp = open('S12_amp ' + timestamp, 'a')
famp.write(amp + "\n")
famp.close()

fphs = open('S12_phs ' + timestamp, 'a')
fphs.write(phs + "\n")
fphs.close()
