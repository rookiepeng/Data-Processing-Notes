%% example MATLAB code to plot data saved by "fullFreqSweep_2Voltages.py"
% By Z. Peng
% Sep. 19, 2016
...
for num=1:46
    %figure;
    strRegion1=strcat('SampleData_fullFreqSweep_2Voltages/',int2str(num),'Region1 20160915 163715');
    strRegion2=strcat('SampleData_fullFreqSweep_2Voltages/',int2str(num),'Region2 20160915 163715');
    strRegion3=strcat('SampleData_fullFreqSweep_2Voltages/',int2str(num),'Region3 20160915 163715');
    strRegion4=strcat('SampleData_fullFreqSweep_2Voltages/',int2str(num),'Region4 20160915 163715');
