...
####
# Automated measurement Python 3.X script for voltage controlled component
#
# Instruments:
...
#                              Voltage1[amp(f1),amp(f2),...,amp(fn)]
#                              Voltage2[amp(f1),amp(f2),...,amp(fn)]
#                              ...
#                              VoltageN[amp(f1),amp(f2),...,amp(fn)]
#        2) "phs <timestamp>": Phase data in degree
#                              Voltage1[phs(f1),phs(f2),...,phs(fn)]
#                              Voltage2[phs(f1),phs(f2),...,phs(fn)]
#                              ...
#                              VoltageN[phs(f1),phs(f2),...,phs(fn)]
#
# Version 1
#
# By: Zhengyu Peng
